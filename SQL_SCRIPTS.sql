...
CREATE TABLE  Crafter.t_crafter_role (
...
insert into Crafter.t_crafter_role (role_name, role_creation_date) value ('ADMIN',SYSDATE());
insert into Crafter.t_crafter_role (role_name, role_creation_date) value ('SUPERUSER',SYSDATE());

select * from Crafter.t_crafter_role;

CREATE TABLE  Crafter.t_crafter_role_access (
...
insert into Crafter.t_crafter_role_access (role_id,
                                        schema_access,
                                        table_access,
...
select * from Crafter.t_crafter_role_access;


CREATE TABLE  Crafter.t_crafter_database (
...
insert into Crafter.t_crafter_database(database_username ,
                                    database_password ,
                                    database_url ,
                                    database_schema,
                                    creation_date)
...
select * from Crafter.t_crafter_database;